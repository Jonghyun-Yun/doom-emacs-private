...
For instance pass En as source for English."
    ...
    (map!
     :leader
     "sgL" #'spacemacs/set-google-translate-languages
     "sgl" #'spacemacs/set-google-translate-target-language
     "sgQ" #'google-translate-query-translate-reverse
     "sgq" #'google-translate-query-translate
     "sgT" #'google-translate-at-point-reverse
     "sgt" #'google-translate-at-point)
    ...
    ;; (setq google-translate-output-destination 'paragraph-overlay)
    ;; (setq google-translate-output-destination 'paragraph-insert)
    ))
