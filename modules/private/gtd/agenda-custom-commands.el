(defun jyun/org-agenda-skip-tag (tag &optional others)
...
(add-to-list 'org-agenda-custom-commands
             '("gs" "Super View"
               ((agenda "" (
                            ...
                            (org-agenda-skip-function '(or (jyun/org-agenda-skip-tag "weekly" nil) (jyun/org-agenda-skip-tag "daily" nil)))
                            ;; (org-agenda-skip-function '(jyun/org-agenda-skip-tag "weekly" nil))
                            ;; (org-agenda-span 10)
                ...
                (tags-todo "-daily-weekly-chore" ((org-agenda-overriding-header "")
                                                  ;; (org-super-agenda-groups
                                                  ;;  '(
                                                  ;;    (:discard (:and (:tag "routine" :tag ("@errand" "daily" "weekly"))))
                                                  ;;    (:name "In Progress"
